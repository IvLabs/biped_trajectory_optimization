...
ground = line([-1 (length(t)/step_time)*max(r45(1,:))+2],[0 0],'Color','m');
axis([-1 (length(t)/step_time)*max(r45(1,:))+2 -1 2])
origin=0;
for i = 1:length(t)
    ...
    swing_f = line([origin+r12(1,i) origin+r24(1,i)],[r12(2,i) r24(2,i)],'Color','yellow');
    swing_t = line([origin+r24(1,i) origin+r45(1,i)],[r24(2,i) r45(2,i)],'Color','black');
