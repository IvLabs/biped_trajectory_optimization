...
class TrajOptSolve():
    ...
    def visualize(self):
        ...
        def animate(i):
            ...
            l_link2_x = [l_link1_x[1], l[1]*np.sin(self.sol_lq2[i]) + l_link1_x[1]]
            l_link2_y = [l_link1_y[1], l[1]*np.cos(self.sol_lq2[i]) + l_link1_y[1]]

            r_link1_x = [rp0[0], l[4]*np.sin(self.sol_rq1[i]) + rp0[0]]
            r_link1_y = [rp0[1], l[4]*np.cos(self.sol_rq1[i]) + rp0[1]]

            r_link2_x = [r_link1_x[1], l[3]*np.sin(self.sol_rq2[i]) + r_link1_x[1]]
            r_link2_y = [r_link1_y[1], l[3]*np.cos(self.sol_rq2[i]) + r_link1_y[1]]

            t_link_x = [l_link2_x[1], l[2]*np.sin(self.sol_tq[i]) + l_link2_x[1]]
            t_link_y = [l_link2_y[1], l[2]*np.cos(self.sol_tq[i]) + l_link2_y[1]]
